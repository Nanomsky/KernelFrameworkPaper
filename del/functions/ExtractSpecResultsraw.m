...
function [ACC, F1] = ExtractSpecResultsraw(A,FileIdx)
...
for i = 1:4
    ...
    Raw_Acc      = [Raw_Acc; RR(7,:)]; % Append the accuracy extract
    Raw_F1_score = [Raw_F1_score; RR(8,:)]; % Append the F1 score extract
    clear Raw RR
end
...
for i = 1:4
    ...
    Norm_Acc = [Norm_Acc; RR(7,:)]; % Append the accuracy extract
    Norm_F1_score = [Norm_F1_score; RR(8,:)]; % Append the F1 score extract
    clear Norm RR
end
...
for i = 1:4
    ...
    Cen_Acc = [Cen_Acc; RR(7,:)]; % Append the accuracy extract
    Cen_F1_score = [Cen_F1_score; RR(8,:)]; % Append the F1 score extract
    clear Cen RR
end
