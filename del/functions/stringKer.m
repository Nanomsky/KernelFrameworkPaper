...
if (nargin < 1) % check correct number of arguments
    ...
    switch lower(ker)
        ...
        case 'k_ed1'
            k = 1-edist_w(u,v,del,ins,rep);
            
        case 'k_ed2'
            k = (exp(-p1*(1-edist_w(u,v,del,ins,rep))));
            
       case 'edistance3'
            k = 0.5*(1-edist_w(u,p1,del,ins,rep)^2 + (1-edist_w(p1,v,del,ins,rep))^2 - (1-edist_w(u,v,del,ins,rep)^2));
            
            
        case 'k_ed4'
            k = (1-edist_w(u,p1,del,ins,rep)) * (1-edist_w(p1,v,del,ins,rep));
            
        case 'k_ed5'
            k = (1-edist_w(u,v,del,ins,rep))/max(length(u),length(v));
        ...
        case 'k_ed6'
            ...
            k = (1-edist_w(u,v,del,ins,rep))/nm;
            
        case 'k_ed7'
            k = (1 - edist_w(u,v,del,ins,rep))/2^numel(intersect(u,v));
