...
for s=1:1
    ...
    for ii=1:num
        ...
        perNegEig{ii+1,1} = L;
        % =========================================================================
        % We traiun a model on the kernel matrix. If it is indefinite, we then
    ...
    %[~ ,T]  = analyseOnevAll4(G,s,L);
    [~ ,T]  = analyseOnevAll4(G,s,0);
